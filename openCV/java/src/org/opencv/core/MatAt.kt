...
fun Mat.get(
    ...
    col: Int,
    data: UByteArray,
) = this.get(row, col, data.asByteArray())

fun Mat.get(
    indices: IntArray,
    data: UByteArray,
) = this.get(indices, data.asByteArray())

fun Mat.put(
    row: Int,
    col: Int,
    data: UByteArray,
) = this.put(row, col, data.asByteArray())

fun Mat.put(
    indices: IntArray,
    data: UByteArray,
) = this.put(indices, data.asByteArray())

fun Mat.get(
    row: Int,
    col: Int,
    data: UShortArray,
) = this.get(row, col, data.asShortArray())

fun Mat.get(
    indices: IntArray,
    data: UShortArray,
) = this.get(indices, data.asShortArray())

fun Mat.put(
    row: Int,
    col: Int,
    data: UShortArray,
) = this.put(row, col, data.asShortArray())

fun Mat.put(
    indices: IntArray,
    data: UShortArray,
) = this.put(indices, data.asShortArray())
...
fun <T> T2(
    _0: T,
    _1: T,
): Tuple2<T> = Tuple2(_0, _1)

fun <T> T3(
    _0: T,
    _1: T,
    _2: T,
): Tuple3<T> = Tuple3(_0, _1, _2)
